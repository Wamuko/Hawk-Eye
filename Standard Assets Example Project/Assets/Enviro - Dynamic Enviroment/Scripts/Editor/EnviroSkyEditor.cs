...
public class EnviroSkyEditor : Editor {
	...
	private string latestVersion = "2.0.1";
	// GUI Styles
	...
	void OnEnable()
	{
        ...
        shadowIntensity = serializedObj.FindProperty("cloudsSettings.castShadows");
